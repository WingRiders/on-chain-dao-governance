...
import {buildFinalizeProposalAction} from '../../src'
...
describe('build finalize proposal', () => {
  beforeEach(() => {
    vi.useFakeTimers()
  })
  ...
  test('successfully builds a transactions for finalizing a proposal', async () => {
    ...
    const finalizeProposal = createAction(buildFinalizeProposalAction, jsApi)
  ...
  test('fails to build a transaction for finalizing if the proposal UTxO is not found', async () => {
    vi.setSystemTime(new Date('2024-08-01T00:00:00Z'))
    const proposalTxHash = 'b8a6e89adc8801e5739b53eee38cdee6ca8d0c3716a5ee83c1f8609c7269a6d5'
